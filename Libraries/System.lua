...
function system.updateDesktop()
	...
	MineOSContextMenu:addItem(localization.aboutSystem).onTouch = function()
		...
		local lines = {
			...
			" ",
			localization.developers or "Developers:",
			" ",
			(localization.IgorTimofeev or "Igor Timofeev") .. ", vk.com/id7799889",
			(localization.GlebTrifonov or "Gleb Trifonov") .. ", vk.com/id88323331",
			(localization.YakovVerevkin or "Yakov Verevkin") .. ", vk.com/id60991376",
			(localization.AlexeySmirnov or "Alexey Smirnov") .. ", vk.com/id23897419",
			(localization.TimofeyShestakov or "Timofey Shestakov") .. ", vk.com/id113499693",
			" ",
			localization.UXadvisers or "UX-advisers:",
			" ",
			(localization.NikitaYarichev or "Nikita Yarichev") .. ", vk.com/id65873873",
			(localization.VyacheslavSazonov or "Vyacheslav Sazonov") .. ", vk.com/id21321257",
			(localization.MichailProsin or "Michail Prosin") .. ", vk.com/id75667079",
			(localization.DmitriiTiunov or "Dmitrii Tiunov") .. ", vk.com/id151541414",
			(localization.EgorPaliev or "Egor Paliev") .. ", vk.com/id83795932", --страница удалена
			(localization.MaximPakin or "Maxim Pakin") .. ", vk.com/id100687922",
			(localization.AndreyKakoito or "Andrey Kakoito") .. ", vk.com/id201043162",
			(localization.MaximOmelaenko or "Maxim Omelaenko") .. ", vk.com/id54662296",
			(localization.KonstantinMayakovskiy or "Konstantin Mayakovskiy") .. ", vk.com/id10069748",
			(localization.RuslanIsaev or "Ruslan Isaev") .. ", vk.com/id181265169",
			"Eugene8388608, vk.com/id287247631",
			" ",
			localization.translators or "Translators:",
			" ",
			"06Games, github.com/06Games",
			(localization.XeniaMazneva or "Xenia Mazneva") .. ", vk.com/id5564402",
			(localization.YanaDmitrieva or "Yana Dmitrieva") .. ", vk.com/id155326634",
		}
