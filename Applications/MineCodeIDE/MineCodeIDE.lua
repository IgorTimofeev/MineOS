...
local function createMainContainer()
	...
	mainContainer.leftTreeView = mainContainer:addChild(GUI.treeView(1, 1, 1, 1, colors.leftTreeView.background, 0x3C3C3C, 0x3C3C3C, 0xEEEEEE, 0x888888, 0x444444, 0x00DBFF, "/"))
	mainContainer.leftTreeView.onFileSelected = function(path)
		loadFile(path)
		mainContainer:draw()
		buffer.draw()
	end
