...
for z = -1, 1 do
	for x = -1, 1 do
		if not (x == 0 and z == 0) then
			setBlock(x, 0, z, color.HSBToHEX(hue, 1, 1))
			hue = hue + hueStep
		end
	end
end
...
-- 			end
-- 			mesh.triangles[triangleIndex][4] = materials.newSolidMaterial(color.HSBToHEX(mesh.hue, 1, mesh.triangles[triangleIndex].brightness))
-- 		end
-- 	end
