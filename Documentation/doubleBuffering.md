...
Низкоуровневый метод, преобразующий экранные координаты в индекс экраннного буфера. К примеру, пиксель 2x1 имеет индекс буфера 4, а пиксель 3x1 имеет индекс буфера 7.
...
Низкоуровневый метод, преобразующий индекс буфера в соответствующие ему координаты на экране.
...
Низкоуровневый метод, устанавливающий соответствующие значения цветов и символа пикселю с указанным индексом.

buffer.**rawGet**( index ): int background, int foreground, char symbol
-----------------------------------------------------------
| *int* | index | Индекс экранного буфера |

Низкоуровневый метод, возвращающий соответствующие значения цветов и символа пикселя с указанным индексом.
