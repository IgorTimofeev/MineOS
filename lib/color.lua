	...
	integerToRGB, RGBToInteger, blend, transition = load([[
		return
			...
			function(firstColor, secondColor, transparency)
				local invertedTransparency, r1, g1, b1, r2, g2, b2 = 1 - transparency, firstColor >> 16, firstColor >> 8 & 0xFF, firstColor & 0xFF, secondColor >> 16, secondColor >> 8 & 0xFF, secondColor & 0xFF
